...
*This post is part of the [ConsiliumBots working paper series](/research). Disclosure: the empirical analysis uses SAE survey microdata held by Chile's Ministry of Education. ConsiliumBots implemented the SAE assignment algorithm under a publicly procured contract from 2021 to 2024. The analysis and interpretations are the authors' own.*
