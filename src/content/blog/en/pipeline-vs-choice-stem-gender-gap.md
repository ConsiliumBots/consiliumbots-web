---
title: "The gap that doesn't move"
subtitle: "Across ten centralized admission systems on five continents, how well women are prepared for STEM varies enormously. Whether high-achieving women rank a STEM program first barely varies at all."
description: "Ten centralized university admission systems, one decomposition: how much of the STEM gender gap is academic preparation, and how much is application choice."
pubDate: 2026-09-08
lang: en
# No byline on this post; the paper's authors are credited as the source below.
authors: []
heroImage: /images/blog/stem-gender-gap/hero.png
ogImage: /images/blog/stem-gender-gap/og.png
tags:
  - Gender
  - STEM
  - Higher education
...
<figure>
  ...
  ![Two panels of horizontal bars for ten admission systems. Panel a, the pipeline gap, runs from -23 points in Uganda to +32 in Sweden and changes sign along the way. Panel b, the choice gap, is negative in all ten, between -36 and -11.](./images/figure2-pipeline-choice.png)
